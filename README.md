...
- :brazil: Brazilian software developer
...
A Pokedex Web App, created with Vue and getting data from [PokeAPI](https://pokeapi.co/). Check it online [here](https://pokedex.padaria.ga/) and check the source code [here](https://github.com/camalejao/pokedex).
...
Web App to download clips from [Twitch](https://twitch.tv) and videos from Youtube. Created with Express and React, but also some tools such as `ytdl-core` and `ffmpeg`. Available online [here](https://clips.padaria.ga), but sometimes it might break due to changes on Twitch API or Youtube services. Check the source code [here](https://github.com/camalejao/clips).
